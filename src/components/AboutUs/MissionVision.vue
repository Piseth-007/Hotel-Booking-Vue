      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        <div>
          ...
          <p class="mt-5 text-gray-500 leading-7 text-[15px]">
            ...
            stay is curated to showcase the warmth, tradition, and artistry of
            Cambodia.
          </p>
        </div>
        ...
        <div>
          ...
          <p class="mt-5 text-gray-500 leading-7 text-[15px]">
            ...
            communities while preserving sacred traditions and iconic
            destinations.
          </p>
        </div>
      </div>
